...
func _ready() -> void:
	...
	match location_type:
		Globals.LOCATION_TYPES.HEADQUARTERS:
			sprite.region_rect = Rect2(144, 144, 48, 48)
		Globals.LOCATION_TYPES.SPACE_STATION:
			sprite.region_rect = Rect2(192, 144, 48, 48)
		Globals.LOCATION_TYPES.SPACE_BAR:
			sprite.region_rect = Rect2(240, 144, 48, 48)
		Globals.LOCATION_TYPES.GAS_GIANT:
			sprite.region_rect = Rect2(144, 192, 48, 48)
		Globals.LOCATION_TYPES.MOON:
			sprite.region_rect = Rect2(192, 192, 48, 48)
